	...
	items: [{
        ...
        listeners: {
            ...
            change : function(field,newValue,oldValue){
                // 找到store
                var brandIdStore = Ext.ComponentQuery.query('checkmodify')[0].down("combobox[name=brandId]").getStore();
        ...
        listeners: {
            ...
            change : function(field,newValue,oldValue){
                // 找到store
                var seriesIdStore = Ext.ComponentQuery.query('checkmodify')[0].down("combobox[name=seriesId]").getStore();
        ...
        listeners: {
            change : function(field,newValue,oldValue){
                // 找到store
                var singleIdStore = Ext.ComponentQuery.query('checkmodify')[0].down("combobox[name=singleId]").getStore();
