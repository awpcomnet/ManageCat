 ...
 *
 */
public class SingleproductHistory implements Serializable{
	private Integer singleHisId;//单品历史ID
	...
	public Integer getSingleHisId() {
		return singleHisId;
	}

	public void setSingleHisId(Integer singleHisId) {
		this.singleHisId = singleHisId;
	}
	...
	public String toString() {
		return "SingleproductHistory [singleHisId=" + singleHisId
				+ ", singleId=" + singleId + ", singleName=" + singleName
				+ ", singleEname=" + singleEname + ", ofOrigin=" + ofOrigin
				+ ", capacity=" + capacity + ", unit=" + unit + ", isUse="
				+ isUse + ", createDate=" + createDate + ", createBy="
				+ createBy + ", updateDate=" + updateDate + ", updateBy="
				+ updateBy + "]";
	}

	private static final long serialVersionUID = 8890861998470191705L;
}
