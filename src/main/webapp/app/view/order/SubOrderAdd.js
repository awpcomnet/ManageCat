 ...
 * 子订单添加
 */
Ext.define("MIS.view.order.SubOrderAdd", {
	extend: "Ext.form.Panel",
	alias: "widget.suborderadd",
...
//	closable: true,
	...
	items: [{
	    ...
	    listeners : {
		       change : function(field,newValue,oldValue){
		    	   var orderPrice = Ext.ComponentQuery.query("suborderadd textfield[name=orderPrice]")[0].getValue();
		    	   var costPrice = Ext.ComponentQuery.query("suborderadd textfield[name=costPrice]")[0];
		    	   if(newValue == '')
		    		   newValue = 0;
		    	   if(orderPrice == '')
	    ...
	    listeners : {
		       change : function(field,newValue,oldValue){
		    	   var orderPrice = Ext.ComponentQuery.query("suborderadd textfield[name=orderPrice]")[0].getValue();
		    	   var transferPrice = Ext.ComponentQuery.query("suborderadd textfield[name=transferPrice]")[0];
		    	   if(newValue == '')
		    		   newValue = 0;
		    	   if(orderPrice == '')
		    		   orderPrice = 0;
